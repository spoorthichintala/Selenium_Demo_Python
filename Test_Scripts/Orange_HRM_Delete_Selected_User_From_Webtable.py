...
username = fields_name.send_keys("Orange"+ str(random_num))
text1=browser.find_element_by_id("customField_name").get_property('value')
print(text1)
...
if text1 in source:
    print(text1 + "user entered is present")
else:
    print(text1 + "user not added in the list")
    browser.refresh()
cellvalue = browser.find_element_by_xpath("//a[text()='" + text1 + "']")

textvalue = cellvalue.text
print(textvalue)
assert text1 == textvalue
